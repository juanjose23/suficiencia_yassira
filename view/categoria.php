            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Lista de Categorias de vehiculos</h3>
...
<div id="modal-default" class="modal fade">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="crear" name="crear" method="POST" action="index.php?c=categoria&a=guardar" autocomplete="off" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="container">
                        <div class="row">
